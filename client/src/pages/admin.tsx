                    ...
                    <TableRow key={user.id} data-testid={`row-user-${user.id}`}>
                      ...
                      <TableCell>
                        <div className="flex gap-2">
                          ...
                          {isLocked(user) ? (
                            <Button variant="outline" size="icon" className='' onClick={() => handleUnlockUser(user.id)}>
                              <Unlock className="h-4 w-4" />
                            </Button>
                          ) : (
                            <Dialog>
                              <DialogTrigger asChild>
                                <Button variant="outline" size="icon" className='' onClick={() => setSelectedUser(user)}>
                          ...
                          <Button variant="destructive" size="icon" className='' onClick={() => handleDeleteUser(user.id)}>
